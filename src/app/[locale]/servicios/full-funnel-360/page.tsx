    ...
    <>
      ...
      <main className="pt-[64px]">
              ...
              <MotionWrapper type="fadeRight" delay={0.1}>
                <div className="bg-[rgba(28,24,40,0.03)] border-[0.5px] border-[rgba(28,24,40,0.08)] rounded-[20px] p-[32px] h-full">
                  ...
                  <ul className="flex flex-col gap-[14px]">
                    {[
                      { text: 'Necesitás leads esta semana — el canal orgánico tarda meses en madurar', pack: 'Growth Machine', href: '/servicios/growth-machine' },
                      { text: 'Recién empezás y no tenés presencia digital todavía', pack: 'Starter Presence', href: '/servicios/starter-presence' },
                      { text: 'Tu problema son las tareas repetitivas internas, no la captación', pack: 'Automation Retainer', href: '/servicios/automation-retainer' },
                    ].map((item, i) => (
        ...
        <CtaFinal
          ...
          cards={[
            { tag: 'Tengo web pero no trae clientes', title: 'Auditoría gratuita', desc: 'Analizamos tu presencia actual y te decimos qué piezas del funnel faltan.', href: '/auditoria-web-gratuita' },
            { tag: 'Quiero entender el proceso', title: 'Mini-curso 5 días', desc: 'Cómo funciona un canal orgánico bien construido. Gratis, en tu inbox.', href: '/email-course' },
