    ...
    <>
      ...
      <main className="pt-[64px]">
              ...
              <MotionWrapper type="fadeRight" delay={0.1}>
                <div className="bg-[rgba(247,246,242,0.025)] border-[0.5px] border-[rgba(247,246,242,0.06)] rounded-[20px] p-[32px] h-full">
                  ...
                  <div className="mt-[20px] pt-[16px] border-t-[0.5px] border-[rgba(247,246,242,0.07)]">
                    <p className="text-[12px] text-[var(--muted-l)]">¿No sabés cuál corresponde?{' '}<a href="/auditoria-web-gratuita" className="text-[var(--am)] font-bold no-underline hover:opacity-80">Pedí la auditoría gratuita →</a></p>
                  </div>
                </div>
              </MotionWrapper>
            </div>
        ...
        <CtaFinal
          ...
          cards={[
            { tag: 'Tengo tienda pero convierte poco', title: 'Auditoría de conversión', desc: 'Revisamos tu tienda y te decimos exactamente dónde se pierden las ventas.', href: '/auditoria-web-gratuita' },
            { tag: 'Quiero entender mis opciones', title: 'Mini-curso 5 días', desc: 'Qué tener en cuenta antes de construir o migrar tu tienda online. Gratis.', href: '/email-course' },
